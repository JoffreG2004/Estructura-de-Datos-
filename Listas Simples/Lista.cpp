...
void Lista::actualizar(std::string nombreViejo, std::string apellidoViejo, std::string nuevoNombre, std::string nuevoApellido) {
    ...
    std::cout << "No se encontró el nodo a actualizar.\n";
}
...
// Método para verificar si el correo ya existe en la lista
...
// Método para generar el correo electrónico basado en el nombre y apellido
